...
const checks = [
  ...
  ["the four V2 pillars remain registered", /path="treinos" element=\{<StudentTrainingLibraryV2 \/>\}/.test(app) && /path="evolucao" element=\{<StudentEvolutionV2 \/>\}/.test(app) && app.includes('path="perfil" element={<StudentProfileV2 />}')],
  ...
  ["logout remains accessible through the shared session command", /aria-label="Sair da área do aluno"/.test(shell) && /encerrarSessao/.test(shell)],
