...
function anamneseParaPayload(anamnese, userId) {
  return {
    ...
    escala_sono: anamnese.escalaSono || "",
    escala_estresse: anamnese.escalaEstresse || "",
    escala_energia: anamnese.escalaEnergia || "",
    escala_fome: anamnese.escalaFome || "",
    escala_motivacao: anamnese.escalaMotivacao || "",
    escala_adesao_rotina: anamnese.escalaAdesaoRotina || "",
    sono: anamnese.qualidadeSono || "",
...
function rowParaAnamnese(row) {
  return {
    ...
    escalaSono: row.escala_sono || row.sono || "",
    escalaEstresse: row.escala_estresse || row.estresse || "",
    escalaEnergia: row.escala_energia || "",
    escalaFome: row.escala_fome || row.fome_noite || "",
    escalaMotivacao: row.escala_motivacao || "",
    escalaAdesaoRotina: row.escala_adesao_rotina || "",
