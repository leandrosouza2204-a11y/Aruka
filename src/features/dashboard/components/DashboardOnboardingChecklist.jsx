...
function DashboardOnboardingChecklist({ status }) {
  const itens = [
    ...
    {
      id: "treino",
      concluido: status.temTreino,
      titulo: "Criar primeiro treino",
      descricao: "Monte uma rotina personalizada ou comece por um modelo rápido.",
      cta: "Criar treino",
      to: "/treinos",
    },
    {
      id: "avaliacao",
      concluido: status.temAvaliacao,
      titulo: "Registrar primeira avaliação",
      descricao: "Registre medidas, histórico e indicadores para acompanhar evolução.",
      cta: "Registrar avaliação",
      to: "/avaliacoes",
    },
    {
      id: "pagamento",
      concluido: status.temPagamento,
      titulo: "Registrar primeiro pagamento",
      descricao: "Confirme o primeiro recebimento para acompanhar receita e pendências.",
