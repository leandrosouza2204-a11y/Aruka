# Hipertrofia Performance — ABCD Intermediário
...
Modelo intermediário de hipertrofia em divisão ABCD, criado para preparar a transição para cargas mais altas, maior densidade e Sprint 03 sem depender de técnicas intensificadoras frequentes.
...
| --- | --- | --- | --- |
| Dia 1 | Treino A | Peitoral e tríceps | 65-80 minutos |
| Dia 2 | Treino B | Costas e bíceps | 65-80 minutos |
| Dia 3 | Treino C | Quadríceps, panturrilhas e core | 65-80 minutos |
| Dia 4 | Treino D | Posteriores, glúteos e deltoides | 65-80 minutos |
...
Concentrar empurrar horizontal com complemento direto de tríceps.
...
| 4 | Tríceps Corda | 2 | 10-12 | 1-2 | 60 s | Rest-Pause | Aplicar apenas na última série com técnica preservada. |

#### Justificativa

A menor mistura muscular permite qualidade alta em peitoral antes de completar extensão de cotovelo.

### Treino B — Costas e bíceps

#### Objetivo da sessão

Organizar puxadas verticais e horizontais com volume direto de bíceps.
...
O bloco separa costas de empurrar e melhora recuperação dos ombros.

### Treino C — Quadríceps, panturrilhas e core

#### Objetivo da sessão

Priorizar joelho, panturrilhas e estabilidade de tronco.
...
A sessão evita excesso de dobradiça para preservar energia para o dia posterior.

### Treino D — Posteriores, glúteos e deltoides

#### Objetivo da sessão

Treinar cadeia posterior e deltoides com fadiga distribuída.
...
| 2 | Mesa Flexora | 3 | 10-15 | 2 | 60-75 s | Tradicional | Controle excêntrico. |
| 3 | Elevação Pélvica | 3 | 8-12 | 2 | 90 s | Tradicional | Pico de contração sem hiperextensão lombar. |
...
Posteriores e ombros dividem demandas sem competir diretamente com quadríceps.
