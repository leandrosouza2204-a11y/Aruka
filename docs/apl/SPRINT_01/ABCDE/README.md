# Sprint 01 - ABCDE Masculino Iniciante

**Status do bloco:** Concluído — aguardando homologação
...
- Sessões mais curtas e previsíveis.
- Menor fadiga local por treino.
- Mais oportunidades semanais de aprendizagem técnica.
- Boa aderência para alunos que preferem treinar todos os dias úteis.
- Separação clara entre peitoral, costas, pernas, ombros, braços e core.
...
| Pesos livres | Baixo | Moderado | Baixo |
| Volume | Moderado | Moderado | Reduzido |

## Critérios para migração para a Sprint 02

Migrar para a Sprint 02 quando o aluno sustentar 8–12 semanas com assiduidade, técnica estável, registro consistente e recuperação adequada. Também é necessário demonstrar domínio de RIR, capacidade de progredir sem perda de amplitude e tolerância a exercícios livres mais presentes.

## Arquivos

- `APL-M-HIP-I-ABCDE-BASE-01.md` - Hipertrofia Base - ABCDE Iniciante.
- `APL-M-HIP-I-ABCDE-PERF-01.md` - Hipertrofia Performance - ABCDE Iniciante.
- `APL-M-HIP-I-ABCDE-EFI-01.md` - Hipertrofia Eficiência - ABCDE Iniciante.
