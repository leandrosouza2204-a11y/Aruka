...
## Production Reconciliation Cutover Review
...
- Next safe group: `PRODUCTION_CUTOVER_AUTHORIZATION_REVIEW`.

## Production Cutover Authorization Review

- Decision: `READY_FOR_SUPERVISED_PRODUCTION_CUTOVER`.
- Technical package ready: `YES`.
- Operational package ready: `READY_WITH_BACKUP_PENDING`.
...
- MAINTENANCE_WINDOW_ESTIMATE: `30-60 min`.
- PRODUCTION_EXECUTION_AUTHORIZED: `NO`.
- DB_PUSH_ALLOWED_NOW: `NO`.
- HISTORY_ALIGNMENT_ALLOWED_NOW: `NO`.
