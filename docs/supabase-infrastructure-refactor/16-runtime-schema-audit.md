...
| table | public | acompanhamento_eventos | N/A | MATCHED | `20260711_historico_acompanhamento_alunos.sql` | Sim | INFORMATIONAL | Estrutura esperada | Incluir na baseline | dump linhas 1015-1034 | Nao |
...
| table | public | aoe_audit_events | N/A | MATCHED | `20260715_aoe_infrastructure_pilot.sql` | Sim | INFORMATIONAL | Estrutura esperada | Incluir na baseline | dump linhas 1133-1150 | Nao |
| table | public | aoe_decision_traces | N/A | MATCHED | `20260715_aoe_infrastructure_pilot.sql` | Sim | INFORMATIONAL | Estrutura esperada | Incluir na baseline | dump linhas 1153-1164 | Nao |
| table | public | aoe_decisions | N/A | MATCHED | `20260715_aoe_infrastructure_pilot.sql` | Sim | INFORMATIONAL | Estrutura esperada | Incluir na baseline | dump linhas 1167-1197 | Nao |
| table | public | aoe_human_reviews | N/A | MATCHED | `20260715_aoe_infrastructure_pilot.sql` | Sim | INFORMATIONAL | Estrutura esperada | Incluir na baseline | dump linhas 1200-1220 | Nao |
| table | public | aoe_idempotency_keys | N/A | MATCHED | `20260715_aoe_infrastructure_pilot.sql` | Sim | INFORMATIONAL | Estrutura esperada | Incluir na baseline | dump linhas 1223-1240 | Nao |
...
| table | public | workout_templates | N/A | MATCHED | `20260714_workout_templates.sql` | Sim | INFORMATIONAL | Estrutura esperada | Incluir na baseline | dump linhas 1419-1441 | Nao |
...
| function | public | aoe_idempotency_get_or_create | `(text,uuid,uuid,text,text,text)` | DIFFERENT_DEFINITION | `20260715_aoe_infrastructure_pilot.sql` | Sim | HIGH | Runtime concede `anon`; Git esperava `authenticated`; funcao insere idempotencia | Remover/justificar `anon` antes da baseline | dump linhas 829-857, grants 2338-2341 | Sim |
| function | public | aoe_user_owns_student | `(uuid)` | DIFFERENT_DEFINITION | `20260715_aoe_infrastructure_pilot.sql` | Sim | MEDIUM | Runtime concede `anon`; usada em RLS | Confirmar se grant anon e necessario | dump linhas 860-872, grants 2345-2348 | Sim |
| function | public | processar_encerramento_automatico_aluno | `(uuid,uuid,date,date,text,uuid,text,integer,text)` | MATCHED | `20260711_rpc_processar_encerramento_automatico.sql` | Sim | MEDIUM | Esperada para Edge Function, grant service role | Manter e testar idempotencia | dump linhas 875-978 | Nao |
| function | public | set_workout_templates_updated_at | `()` | DIFFERENT_DEFINITION | `20260714_workout_templates.sql` | Sim | LOW | Runtime concede `anon/authenticated/service_role`; trigger function sem search_path | Reduzir grants no ciclo de hardening se aplicavel | dump linhas 981-991, grants 2357-2359 | Sim |
...
| trigger | public | set_workout_templates_updated_at | `before update on workout_templates` | MATCHED | `20260714_workout_templates.sql` | Sim | INFORMATIONAL | Atualiza `updated_at` | Incluir na baseline | dump linha 1773 | Nao |
| storage | storage | avaliacoes-fotos bucket/policies | N/A | UNKNOWN_REQUIRES_CATALOG_QUERY | `20260710_storage_avaliacoes_fotos.sql` | Nao visivel no dump public | MEDIUM | Baseline precisa confirmar Storage runtime | Executar catalog query read-only em ciclo aprovado | docs Ciclo 1 + dump sem storage DDL | Sim |
