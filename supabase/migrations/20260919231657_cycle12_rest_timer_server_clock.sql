-- Cycle 12.7: add a bounded backend clock anchor to the existing Player read.
-- Persisted set timestamps and prescribed rest snapshots remain the canonical
-- rest inputs; no timer state, periodic write, table or new RPC is introduced.
